        ...
        <div className="grid grid-cols-2 gap-4">
          {services.map((service) => (
            <button 
              ...
              className="bg-white dark:bg-zinc-900 border border-[#F5E6DA] dark:border-zinc-800 rounded-[2.5rem] p-5 flex flex-col items-center text-center gap-5 shadow-sm active:scale-[0.97] transition-all group"
            >
              <div className="w-14 h-14 bg-[#FAF7F5] dark:bg-zinc-800 text-[#D4B499] rounded-[1.5rem] flex items-center justify-center shadow-inner group-hover:scale-110 transition-transform">
                 <Plus size={24} />
              </div>
              <h4 className="text-[10px] font-bold dark:text-white uppercase tracking-wider">{service.name}</h4>
            </button>
          ))}
        </div>
      </section>
